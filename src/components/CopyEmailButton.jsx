...
const CopyEmailButton = () => {
    ...
    const email = "anjaliacharya0512@gmail.com";
    const copyToClipboard = () => {
        navigator.clipboard.writeText(email);
        setCopied(true);
        setTimeout(() => setCopied(false), 2000);
    }
  return <motion.button onClick={copyToClipboard} whileHover={{y:-5}} whileTap={{y:1.05}} className="relative px-1 py-4 text-sm text-center rounded-full font-extralight bg-primary w-[12rem] cursor-pointer overflow-hidden">
